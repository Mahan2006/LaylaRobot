...
**Keep in mind this bot is made only for @KannadaMVRequest.**
"""
...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(
            text="Support", url=f"https://t.me/KannadaMVRequest"),
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.reply_sticker("CAACAgEAAxkBAAIPzGDQqX5DydmJppdkw1oTe29ErF1ZAAKJAQACyBxgRp2VIIktwpB6HgQ")
